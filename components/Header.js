...
function Header () {
    ...
    return(
        ...
        <p style={{marginRight:20, marginTop:12}}>   Bitex, Assistant for your trading</p>
        </div>
        ...
        <div className="menu-dash">
            <div className="menu-opn">
                ...
                <Link href="/pages/Wallet/"> <button className="btn-menu-dash"> <CiCoinInsert/> Wallet</button> </Link>
                ...
                <Link href="/pages/Support/"><button className="btn-menu-dash"> <CiLocationArrow1/> Support Team</button> </Link> 
        </div>
